...
ActiveRecord::Schema.define(version: 2020_10_22_053641) do
  ...
  create_table "shipping_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchaser_id"], name: "index_shipping_addresses_on_purchaser_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "nickname"
    t.string "first_name_zen"
    t.string "last_name_zen"
  ...
  add_foreign_key "shipping_addresses", "purchasers"
end
